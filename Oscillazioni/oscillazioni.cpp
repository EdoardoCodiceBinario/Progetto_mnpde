...
In questo file si costruisce un esempio che faccia vedere 
esplicitamente le oscillazioni generate da un problema a diffusione
dominata, accentuate sul bordo nei pressi di (1,1).
*/
...
void DiffTras<dim>::output_results(const unsigned int cycle) const
{
  ...
  auto fname =
    "solution-oscillazione-" + std::to_string(dim) + "d_" + std::to_string(cycle) + ".vtu";
  ...
  std::ofstream pvd_output("solution-oscillazione-" + std::to_string(dim) + "d.pvd");
